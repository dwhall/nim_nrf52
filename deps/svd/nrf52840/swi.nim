...
declareRegister(peripheralName = SWI0, registerName = UNUSED, addressOffset = 0x000'u32, dim = 0, dimIncrement = 0, readAccess = true, writeAccess = false, registerDesc = "Unused.")
...
declareRegister(peripheralName = SWI1, registerName = UNUSED, addressOffset = 0x000'u32, dim = 0, dimIncrement = 0, readAccess = true, writeAccess = false, registerDesc = "Unused.")
...
declareRegister(peripheralName = SWI2, registerName = UNUSED, addressOffset = 0x000'u32, dim = 0, dimIncrement = 0, readAccess = true, writeAccess = false, registerDesc = "Unused.")
...
declareRegister(peripheralName = SWI3, registerName = UNUSED, addressOffset = 0x000'u32, dim = 0, dimIncrement = 0, readAccess = true, writeAccess = false, registerDesc = "Unused.")
...
declareRegister(peripheralName = SWI4, registerName = UNUSED, addressOffset = 0x000'u32, dim = 0, dimIncrement = 0, readAccess = true, writeAccess = false, registerDesc = "Unused.")
...
declareRegister(peripheralName = SWI5, registerName = UNUSED, addressOffset = 0x000'u32, dim = 0, dimIncrement = 0, readAccess = true, writeAccess = false, registerDesc = "Unused.")
